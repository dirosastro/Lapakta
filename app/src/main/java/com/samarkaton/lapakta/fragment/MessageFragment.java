...
import com.samarkaton.lapakta.activity.ChatActivity;
...
import com.samarkaton.lapakta.item.MessageItem;
import com.samarkaton.lapakta.models.MessageModels;
...
public class MessageFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootRef = FirebaseDatabase.getInstance(getResources().getString(R.string.firebase_db)).getReference();
